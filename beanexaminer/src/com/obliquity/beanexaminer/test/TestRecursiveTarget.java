...
public class TestRecursiveTarget {
	public static void main(String[] args) {
		RecursiveTarget target = new RecursiveTarget("Wilbur");
		
		target.setChildNode(target);
		
		Handler h = new DefaultHandler(true);
		
		try {
			Examiner.examine(target, 0, h, 5);
